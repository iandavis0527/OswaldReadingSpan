...
test("ensure set wraps if too many requested", () => {
    ...
    expect(practice_set[0][practice_set[0].length - 1]).toStrictEqual(practice_set[0][0]);
    expect(practice_set[1][practice_set[1].length - 1]).toStrictEqual(practice_set[1][0]);
    expect(practice_set[2][practice_set[2].length - 1]).toStrictEqual(practice_set[2][0]);
});
